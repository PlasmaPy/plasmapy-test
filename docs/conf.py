...
project = "PlasmaPy"
author = "plasmapy-test-helpers Developers"
...
# B, not F).
modindex_common_prefix = ["plasmapy_test_helpers."]

# -- Options for HTMLHelp output ------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "plasmapy_test_helpers_doc"
...
latex_documents = [
    (
        master_doc,
        "plasmapy_test-helpers.tex",
        "plasmapy-test-helpers Documentation",
        "plasmapy-test-helpers developers",
        "manual",
    )
]
...
man_pages = [(master_doc, "plasmapy_test_helpers", "plasmapy-test-helpers Documentation", [author], 1)]
